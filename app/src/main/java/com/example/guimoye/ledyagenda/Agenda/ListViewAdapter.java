...
public class ListViewAdapter extends BaseAdapter {
    ...
    public ListViewAdapter(Context context,  ArrayList<String> getId, ArrayList<String> getFecha,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        imgPermiso.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, VerDatosAgenda.class);
                intent.putExtra("id", getId.get(position));
              //  intent.putExtra("fecha", getTipo[position]);
                Log.e("llamooo lenarr","enviando el id "+getId.get(position));
