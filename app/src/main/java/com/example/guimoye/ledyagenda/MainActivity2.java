...
import com.example.guimoye.ledyagenda.Agenda.ConsultaFragmentUsu;
import com.example.guimoye.ledyagenda.Asistencia.AsistenciaFragment;
import com.example.guimoye.ledyagenda.Asistencia.AsistenciaFragmentUsu;
...
public class MainActivity2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.nav_consultar);

        FragmentManager fm = getFragmentManager();
        fm.beginTransaction().replace(R.id.content_frame, new ConsultaFragmentUsu()).commit();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_perfil) {
           ...
           fm.beginTransaction().replace(R.id.content_frame, new ConsultaFragmentUsu()).commit();
            ...
            fm.beginTransaction().replace(R.id.content_frame, new AsistenciaFragmentUsu()).commit();
