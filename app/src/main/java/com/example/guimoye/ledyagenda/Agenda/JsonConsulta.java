...
public class JsonConsulta {
   ...
   // JsonUsersDelete ju;
    ...
    public JsonConsulta(View v, LayoutInflater inflater, ViewGroup container,
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, direccion,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            adapter = new ListViewAdapter(myContext, id,fecha,nombre_evento,status,descripcion,imagenes);
